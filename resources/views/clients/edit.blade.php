            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="form-row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="trade_name" id="trade_name" required value="{{ $client->trade_name }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="phone_number" id="phone_number" required value="{{ $client->phone_number }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select class="form-control selectpicker" name="address[country]" id="address_country"
                            ...
                            <option value="" disabled {{ $client->address->country ?: 'selected' }}>@lang('common.select')</option>
                            @foreach($countries as $c_code => $c_name)
                                <option {{ $client->address->country && $client->address->country == $c_code ? 'selected' : "" }} value="{{ $c_code }}">{{ $c_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="address_city" class="control-label">@lang('client.city')</label>
                        <input type="text" name="address[city]" id="address_city" value="{{ $client->address->city }}"
                               placeholder="@lang('client.city')" class="form-control">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="address_sub" class="control-label">@lang('client.address_sub')</label>
                        <input type="text" name="address[sub]" id="address_sub" value="{{ $client->address->sub }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="address[maps]" id="address_maps" value="{{ $client->address->maps }}"
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <select name="zone_id" id="zone_id" class="form-control selectpicker" data-live-search="true" required>
                            <option value="" disabled {{ $client->zone_id ?: 'selected' }}>@lang('common.select')</option>
                            @foreach($zones as $zone)
                                <option {{ $client->zone_id && $client->zone_id == $c_code ? 'selected' : "" }} value="{{ $zone->id }}">{{ $zone->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="pickup_address[text]" id="pickup_address_text" value="{{ $client->pickup_address->text }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="pickup_address[maps]" id="pickup_address_maps" value="{{ $client->pickup_address->maps }}"
                               placeholder="@lang('client.maps_placeholder')" class="form-control">
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="sector" class="control-label">@lang('client.sector')</label>
                        <input type="text" name="sector" id="sector" value="{{ $client->sector }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select name="category" id="category" required class="selectpicker form-control">
                            <option {{ $client->category == 1 ? 'selected' : 0 }} value="1">@lang('client.online_store')</option>
                            <option {{ $client->category == 2 ? 'selected' : 0 }} value="2">@lang('client.local_store')</option>
                        </select>
                    </div>
                    <div class="col-12">
                        <hr>
                    ...
                    <div class="form-group col-sm-6">
                        <input type="text" name="bank[name]" id="bank_name" value="{{ $client->bank->name }}"
                               placeholder="@lang('client.bank.name')" class="form-control">
                    </div>
                    <div class="form-group col-sm-6">
                        <input type="text" name="bank[account_number]" id="bank_account_number" value="{{ $client->bank->account_number }}"
                               placeholder="@lang('client.bank.account_number')" class="form-control">
                    </div>
                    <div class="form-group col-sm-6">
                        <input type="text" name="bank[holder_name]" id="bank_holder_name" value="{{ $client->bank->holder_name }}"
                               placeholder="@lang('client.bank.holder_name')" class="form-control">
                    </div>
                    <div class="form-group col-sm-6">
                        <input type="text" name="bank[iban]" id="bank_iban" value="{{ $client->bank->iban }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="urls[website]" id="urls_website" value="{{ $client->urls->website }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="urls[facebook]" id="urls_facebook" value="{{ $client->urls->facebook }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="urls[instagram]" id="urls_instagram" value="{{ $client->urls->instagram }}"
            ...
            <div class="col-md-3">
                <div class="custom-sticky-top">
                    <div class="extra-form-info">
                        ...
                        <div class="form-readonly">{{ $client->account_number ?? "" }}</div>
                    </div>
