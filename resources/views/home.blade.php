    ...
    <div class="row">
        <div class="col-md-8 col-visitors">
            <div class="card no-bd bd-3 card-stat">
                <div class="card-body">
                    <h3 class="m-0 mb-2 font-weight-bold"><i class="icon-graph mr-2"></i>@lang("dashboard.stats.label")</h3>
                    <div class="row">
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/shipments.php">
                        ...
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/shipments.php?received=show">
                            <div class="widget-info">
                                <div class="left">
                        ...
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/shipments.php?deliveredtoday=show">
                            <div class="widget-info">
                                <div class="left">
                        ...
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/pickups.php?today=get">
                            <div class="widget-info">
                                <div class="left">
                        ...
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/clients.php">
                            <div class="widget-info">
                                <div class="left">
                        ...
                        <a class="col-md-4 col-sm-6 col-xs-12" href="/couriers.php">
                            <div class="widget-info">
                                <div class="left">
