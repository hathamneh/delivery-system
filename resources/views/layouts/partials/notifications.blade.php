...
<li class="dropdown" id="notifications-header">
    <a href="#" class="dropdown-toggle" data-hover="dropdown" data-close-others="true"
       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="icon-bell"></i>
        <span class="badge badge-danger badge-header notifications-count"></span>
    </a>
    <div class="dropdown-menu bg-transparent">
        ...
        <div class="notifications-list-footer">
            <button class="btn btn-link read-all" type="button"><i class="fa-check"></i> Mark all as read</button>
        </div>
    </div>
</li>
